...
class Discourse extends React.Component {
  constructor(props) {
    ...
    if (Platform.OS === 'ios') {
      ...
      OneSignal.init("673809b0-5765-45e1-bd94-3d02b8a3a5c8", {kOSSettingsKeyAutoPrompt : false, kOSSettingsKeyInAppLaunchURL: false, kOSSettingsKeyInFocusDisplayOption:2});
